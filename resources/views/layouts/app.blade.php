    ...
    <div class="main-wrapper">
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="/home"><img src="{{ asset('images/logo.png') }}"></a>
          </div>
          ...
          <ul class="sidebar-menu">
              ...
              @include('partials.mnuSales')
              @include('partials.mnuAdmin')
      ...
      <footer class="main-footer">
        <div class="footer-left">
            &copy; Newborder <?php echo date('Y');?> | Powered by <a href="http://www.newborder.cl" target="_blank">NB Group</a>
        </div>
